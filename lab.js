...
if(temperature >= 80 && rain === true){
  ...
  console.log('Please wear a rain-jacket');
}
else if(temperature <= 60 && rain === true){
  console.log('Please wear a jacket and carry an umbrella.');
}
else if(temperature >= 80 && rain === false){
  console.log('Please wear a cotton clothing, its hot outside!');
}
else if(temperature > 60 && temperature < 80 &&  rain === false){
  console.log('Wear any clothing of your choice. Its the perfect weather out there!');
}
